<%@ Page Title="Profile" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="DBLabProject.Profile" %>
                ...
                <div class="Card-Body">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-10">
                            <asp:Button runat="server" Text="Update" CssClass="btn btn-primary" ID="btnUpdate" OnClick="btnUpdate_Click"/>
                        </div>
                    </div>
                </div>
            </div>
